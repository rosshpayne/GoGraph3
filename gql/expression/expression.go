...
// rootfunc needs only lexer/parser to determine func to execute, which returns []{[]uuid.UID, Type}, where each item is passed to expression to return true/false
