...
type DataItem struct {
	...
	I int64   // spanner int
	N int64   //edge count (dynamodb, spanner), integer, float DTs (dynamodb)
...
func (dgv *DataItem) GetI() int64 {
	//return dgv.I // TODO: how to handle. SQL uses I & F no-SQL uses N. Maybe both SQL & non-SQL use I & F which are both Number type in no-SQL ???
	return dgv.I // for dynamodb only. All numbers (int, floats) stored in N attribute (dtype: Number)
}
